...
export default function AddProductClient() {
    ...
    return (
        <Drawer>
            <DrawerTrigger>
                <Button text={'+ Add Product'} type={'button'} className={'mr-5'} />
            </DrawerTrigger>
            <DrawerContent>
                <DrawerHeader>
                    <DrawerTitle className=' text-center'>Add Product</DrawerTitle>
                    <DrawerDescription className=' text-center'>Add Product for your shop.</DrawerDescription>
                </DrawerHeader>
