    ...
    <>
        ...
        >
            ...
            <div className="w-fit flex-col  flex  justify-center">
                ...
                <h1 className="newFont text-3xl font-bold">Quick Basket</h1>
                <p className="text-sm  leading-[120%] ">
                    Discover the latest trends. Shop with ease. Delivered to your door.
                </p>
                </article>
            </div>
            ...
            <div className="sm:block flex sm:mt-0 mt-4  gap-2 sm:w-auto w-full sm:space-y-2 relative z-[1]">
                ...
                <svg
                    ...
                    viewBox="0 0 70 62"
                    fill="none"
                    className="sm:w-24 w-full text-white"
                >
                    <path
            ...
            <div className="lg:flex hidden mt-24">
                <AnimatedText
                    text="QUICK BASKET"
